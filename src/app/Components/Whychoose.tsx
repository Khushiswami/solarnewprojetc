...
export default function WhyChoose() {
  ...
  return (
    ...
    >
      ...
      >
        Why choose{" "}
        <span className="text-[#f6a235]">Gayatri Construction Company</span> for
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <FaHardHat className="text-[#f6a235] text-3xl flex-shrink-0" />
          <div>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <FaBuilding className="text-[#f6a235] text-3xl flex-shrink-0" />
          <div>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <FaTools className="text-[#f6a235] text-3xl flex-shrink-0" />
          <div>
            <h3 className="text-xl font-semibold mb-1">
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <FaClock className="text-[#f6a235] text-3xl flex-shrink-0" />
          <div>
            <h3 className="text-xl font-semibold mb-1">
      ...
      <motion.div className="text-center mt-12" variants={itemVariants}>
        <button className="px-8 py-3 rounded-lg bg-[#f6a235] text-white font-medium hover:bg-[#c74c17] transition">
          Learn More About Us
        </button>
      </motion.div>
    </motion.section>
